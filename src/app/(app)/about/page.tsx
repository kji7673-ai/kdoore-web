...
export default async function AboutPage() {
  ...
  if (dbUrl && !dbUrl.includes('placeholder')) {
    try {
      ...
      cmsData = await payload.findGlobal({ slug: 'about' });
    } catch (e) {
    ...
    <main className="min-h-screen bg-gray-50 pt-24 pb-12">
      ...
      <div className="bg-apple-surface-tile-1 text-white py-24 relative overflow-hidden">
        <div className="absolute inset-0 z-0 bg-apple-surface-tile-1">
          <Image 
            src={cmsData?.heroBgImage?.url || "/images/legacy/slide_about.jpg"} 
            alt="About Banner" 
            fill 
        ...
        <div className="container mx-auto px-6 max-w-5xl relative z-10 text-center">
          <h1 className="text-apple-display-lg md:text-apple-hero-display font-bold mb-6">
            {cmsData?.heroTitle || '더 멀리 함께하는 기업! 케이두레'}
          </h1>
          <p className="text-apple-lead-airy text-apple-body-muted max-w-2xl mx-auto">
            {cmsData?.heroSubtitle || '고객만족을 위하고 새로운 도약을 준비하는 케이두레'}
          </p>
        </div>
      </div>
      ...
      <div id="history">
        <TimelineSection timelineData={cmsData?.timeline} />
      </div>
      ...
      <section id="certifications" className="py-20 bg-gray-100">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <CertificationsGallery items={cmsData?.certifications?.length > 0 ? cmsData.certifications : [
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-12 bg-gray-50 rounded-2xl p-8 border border-gray-100">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">{cmsData?.address || '서울특별시 강서구 등촌로 51바길 14'}</p>
                      <p className="text-gray-500 text-sm">{cmsData?.addressDetail || '(등촌동 566-5)'}</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <p className="text-gray-900 font-medium">{cmsData?.phone || '02-2668-0311'}</p>
                  </div>
                  <div className="flex items-center">
                    <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center mr-4 shrink-0">
                      <Mail className="w-5 h-5 text-purple-600" />
                    </div>
                    <p className="text-gray-900 font-medium">{cmsData?.email || 'kedure@hanmail.net'}</p>
                  </div>
                  <div className="flex items-center">
                    <Clock className="w-5 h-5 text-blue-600 mr-3" />
                    <p className="text-gray-900">{cmsData?.hours || '평일 09:00 - 18:00 (주말/공휴일 휴무)'}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="h-[300px] md:h-full min-h-[300px] rounded-xl overflow-hidden shadow-inner border border-gray-200">
              <iframe
                src={cmsData?.mapIframe || "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3163.2678688461715!2d126.85822361531101!3d37.54877707980126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357c9c6bb11c1d81%3A0x8e5f2e6e3c9c6f2a!2z7ISc7Jq47Yq567OE7IucIOq강서구 등촌로51바길 14!5e0!3m2!1sko!2skr!4v1626230357000!5m2!1sko!2skr"}
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
